...
```bash
create-psylon version 1.0.0                                                                                                                                                                                                 4:55:00 PM
? Target directory my-psylon
...
◐ Creating psylon in /Users/schettn/Documents/my-psylon                                                                                                                                          4:55:11 PM
✔ Psylon created                                                                                                                                                                                                           4:55:11 PM
...
? Port of the psylon server to generate the client from 3000
◐ Updating psylon dev script to generate client                                                                                                                                                                             4:55:20 PM
✔ Psylon dev script updated                                                                                                                                                                                                4:55:20 PM

 ╭───────────────────────────────────────────╮
 │                                           │
 │  Psylon successfully created in my-psylon.  │
 │                                           │
 │  Happy coding!                            │
 │                                           │
 ╰───────────────────────────────────────────╯
